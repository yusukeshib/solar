...
export const METERS_PER_ASTRONOMICAL_UNIT = 1.4959787e+11;
export const METERS_PER_EARTH_EQUATORIAL_RADIUS = 6378140.0;
export const EARTH_RADII_PER_ASTRONOMICAL_UNIT = METERS_PER_ASTRONOMICAL_UNIT / METERS_PER_EARTH_EQUATORIAL_RADIUS;      // 23454.78
...
export function Star(x, y, z) {
    this.EclipticCartesianCoordinates = function(day)
    {
      ...
      // eq -> ec
      var qx = x;
      var qy =  (y * cosK) + (z * sinK);
      var qz = -(y * sinK) + (z * cosK);

      return new CartesianCoordinates (qx, qy, qz);
    }

    this.EclipticAngularCoordinates = function(day)
    {
        return new SphericalCoordinates (x, y, z);
    }
